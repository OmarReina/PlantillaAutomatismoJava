...
import co.com.claro.overtemp.dto.EquipmentHwEnvironmentDto;
import co.com.claro.overtemp.enums.ERequestSOAP;
import co.com.claro.overtemp.util.Util;
import co.com.claro.overtemp.ws.soap.client.ConsumoGenericoSoap;
        ...
        try {
            ...
            equipments.addAll(
                    Util.readXMLToListDto(
                            Util.getXmlOfSSH(
                                    RoutineProperties.getProperties().get(Constans.SERVER_SSH_NSP18_IP).getValue(),
                                    RoutineProperties.getProperties().get(Constans.SERVER_SSH_NSP18_USER).getValue(),
                                    RoutineProperties.getProperties().get(Constans.SERVER_SSH_NSP18_PASSW).getValue(),
                                    RoutineProperties.getProperties().get(Constans.SERVER_SSH_NSP18_PATH).getValue()
                            ),
            ...
            equipments.addAll(
                    Util.readXMLToListDto(
                            Util.getXmlOfSSH(
                                    RoutineProperties.getProperties().get(Constans.SERVER_SSH_NSP21_IP).getValue(),
                                    RoutineProperties.getProperties().get(Constans.SERVER_SSH_NSP21_USER).getValue(),
                                    RoutineProperties.getProperties().get(Constans.SERVER_SSH_NSP21_PASSW).getValue(),
                                    RoutineProperties.getProperties().get(Constans.SERVER_SSH_NSP21_PATH).getValue()
                            ),
                            Constans.TAG_EQUIPMENT_HW_ENVIRONMENT,
                            EquipmentHwEnvironmentDto.class,
                            fields
